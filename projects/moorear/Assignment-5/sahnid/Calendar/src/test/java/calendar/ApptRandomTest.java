...
public class ApptRandomTest {
   ...
   /**
	...
	//			System.out.println(" Seed:"+randomseed );
				...
				int badstartHour=ValuesGenerator.getRandomIntBetween(random, 1, 24);
				int badstartMinute=ValuesGenerator.getRandomIntBetween(random, 1, 120);
				int badstartDay=ValuesGenerator.getRandomIntBetween(random, 1, 62);
				int badstartMonth=ValuesGenerator.getRandomIntBetween(random, 1, 24);
				int badstartYear=ValuesGenerator.getRandomIntBetween(random, -2018, 2018);

				//Construct a new Appointment object with the initial data
				//Construct a new Appointment object with the initial data
						Appt badappt = new Appt(badstartHour,
										 badstartMinute ,
										 badstartDay ,
										 badstartMonth ,
										 badstartYear ,
